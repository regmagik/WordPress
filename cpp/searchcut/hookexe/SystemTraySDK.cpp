...
//    lstrncpy(m_tnd.szTip, szToolTip, m_nMaxTooltipLength);
    lstrcpy(m_tnd.szTip, szToolTip);
//Select any text and press Ctrl+Ins+Ins to search.
#ifdef SYSTEMTRAY_USEW2K
...
//#else
//    lstrncpy(strBuffer, m_tnd.szTip, m_nMaxTooltipLength-1);
    lstrcpy(strBuffer, m_tnd.szTip);
//#endif
...
LRESULT CSystemTray::OnTrayNotification(UINT wParam, LONG lParam) 
{
    ...
    // Clicking brings up a context menu
